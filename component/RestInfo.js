    ...
    return(
        ...
        <div className="flex w-full justify-between mb-2 pb-2">
          <div className="w-[70%] ">
            ...
            <p className="h-19 overflow-y-hidden">
          ...
          <div className="w-[20%] relative">
            ...
            <button className="absolute bottom-1 left-15 rounded-xl text-2xl text-green-600 px-6 py-2 shadow-md border border-white bg-white">ADD</button>
          </div>
        </div>
